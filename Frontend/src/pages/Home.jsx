...
import { getCardData } from '../services/operations/DataOperations'
...
function Home() {
 ...
 async function getData(){
  ...
  return (
    ...
    <div class="pt-24 bg-[linear-gradient(90deg,_#d53369_0%,_#daae51_100%)] text-white" >
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          ...
          <img class="w-full md:w-4/5 lg:mx-auto z-50" src={hero} />
        </div>
      </div>
    </div>
    <div class="relative -mt-12 lg:-mt-24 bg-[linear-gradient(90deg,_#d53369_0%,_#daae51_100%)] text-white">
    ...
    <section class="container mx-auto text-center py-6 mb-12 text-black lg:flex-col ju">
      ...
      <h3 class="my-4 text-3xl leading-tight">
        Maintain all work related data for myself!
      </h3>
      <div onClick={()=>setToggleClick((prev)=>!prev)} class="mx-auto w-fit  bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg  cursor-pointer transform transition hover:scale-105 duration-300 ease-in-out">
        Today's Data - {currentDate}
      </div>
    </section>

    <div className='w-11/12 mx-auto'>
       {toggleClick&&<TodayData data={data}/> }
    </div>
